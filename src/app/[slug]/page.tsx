...
const page = async ({params}: { params : {slug:string}}) => {
  ...
  if(!(await products).items[0]) {
    return notFound()
  }

  const product = (await products).items[0]
  return (
    <div className='px-4 md:px-8 lg:px-16 xl:px-32 2xl:px-64 relative flex flex-col lg:flex-row gap-16'>
      ...
      <Add productId={product._id || ""} variantId="00000000-0000-0000-0000-00000000000" stockNumber={product.stock?.quantity || 0}/>
        )}
      <div className='h-[2px] bg-gray-100'/>
      {product.additionalInfoSections?.map((section:any ) => (
        <div className='text-sm' key={section.tile}>
